    ...
    <div class="relative w-full p-6 bg-gradient-to-b from-[#535353] to-[#121212]">
      <div class="flex gap-6 items-end">
        ...
        <div class="w-[232px] h-[232px] shadow-xl flex-shrink-0 group relative cursor-pointer" @click="handlePlayRank">
          ...
          <div
            class="absolute inset-0 bg-black/20 group-hover:bg-black/40 transition-colors rounded flex items-center justify-center opacity-0 group-hover:opacity-100">
            <div
              class="w-12 h-12 rounded-full bg-[#1db954] flex items-center justify-center shadow-lg transform scale-100 hover:scale-105 transition-all">
